...
// Only these exact patterns:
make_col is_customer_relationship: int64(cloudwatch_log ~ "Other exception response for Customers Relationships" OR cloudwatch_log ~ "RequestException for Customers Relationships")
make_col is_money_movement:        int64(cloudwatch_log ~ "error making money movement request")
